...
return (self["webpackChunkjodit"] = self["webpackChunkjodit"] || []).push([[881],{
...
__webpack_require__.d(__webpack_exports__, {
  "buttonGenerator": function() { return /* binding */ buttonGenerator; }
});
...
;// CONCATENATED MODULE: ./src/plugins/button-generator/ui/button/button.ts
var UIGButton_1;
...
let UIGButton = UIGButton_1 = class UIGButton extends ui/* UIElement */.u1 {
    ...
    updateStyles() {
        ...
        (0,helpers.assert)(btn != null, 'button element does not exist');
    ...
    static applyStyle(style, btn) {
        const _ = (v) => ((0,checker/* isString */.HD)(v) ? v : v + 'px');
    ...
    static extractStyle(state, target) {
        ...
        Object.assign(state, {
            ...
            ...extractColors(),
            borderColor: (_b = style === null || style === void 0 ? void 0 : style.borderColor) !== null && _b !== void 0 ? _b : '#18ab29',
            borderRadius: (_c = style === null || style === void 0 ? void 0 : style.borderRadius) !== null && _c !== void 0 ? _c : 0,
            borderSize: (_d = style === null || style === void 0 ? void 0 : style.borderWidth) !== null && _d !== void 0 ? _d : 1,
            ...extractShadow([
                'boxShadowOffsetX',
                'boxShadowOffsetY',
                'boxShadowBlurRadius',
...
(0,tslib_es6/* __decorate */.gn)([
    (0,decorators.watch)('style')
], UIGButton.prototype, "updateStyles", null);
UIGButton = UIGButton_1 = (0,tslib_es6/* __decorate */.gn)([
...
;// CONCATENATED MODULE: ./src/plugins/button-generator/ui/preview/preview.ts
...
let UIPreviewButtonGenerator = class UIPreviewButtonGenerator extends ui/* UIElement */.u1 {
    constructor(jodit, state, updateState) {
        super(jodit);
        this.state = state;
        this.updateState = updateState;
        this.button = new UIGButton(this.j, this.state);
        ...
        this.colors = [
            ...
            return new color_input/* ColorInput */.T(this.j, {
                name: key,
                onChange: (value) => {
                    if (!this.lockUpdate) {
        ...
        (0,helpers.assert)(button != null, 'button element does not exists');
        button.appendChild(this.button.container);
        const colors = this.getElm('colors');
        (0,helpers.assert)(colors != null, 'colors element does not exists');
...
UIPreviewButtonGenerator = (0,tslib_es6/* __decorate */.gn)([
    decorators.component
...
;// CONCATENATED MODULE: ./src/plugins/button-generator/ui/form/form.ts
...
class UIFormButtonGenerator extends ui/* UIElement */.u1 {
    constructor(jodit, state, updateState) {
        super(jodit);
        this.state = state;
        this.updateState = updateState;
        ...
        (0,to_array/* toArray */.q)(this.container.querySelectorAll('input,select')).forEach((input) => {
            if (dom/* Dom.isTag */.i.isTag(input, 'select')) {
                const uiInput = new ui/* UISelect */.Cj(this.j, {
                    options: (0,to_array/* toArray */.q)(input.options).map(opt => ({
                        text: opt.innerText,
                        value: opt.value
                    })),
                    onChange: (value) => {
                ...
                dom/* Dom.replace */.i.replace(input, uiInput.container, this.j.create, false, true);
                this.onUpdates.push(getOnUpdate(uiInput, input));
                return;
            }
            if (dom/* Dom.isTag */.i.isTag(input, 'input')) {
                switch (input.type) {
                    case 'range': {
                        const uiInput = new range/* UIRange */.W(this.j, {
                        ...
                        dom/* Dom.replace */.i.replace(input, uiInput.container, this.j.create);
                        this.onUpdates.push(getOnUpdate(uiInput, input));
                        return;
                    }
                    case 'text': {
                        const uiInput = new ui/* UIInput */.u3(this.j, {
    ...
    update() {
        ...
        (0,helpers.assert)(boxShadow != null, 'box-shadow does not exists');
        const textShadow = this.getElm('text-shadow');
        (0,helpers.assert)(textShadow != null, 'text-shadow does not exists');
...
;// CONCATENATED MODULE: ./src/plugins/button-generator/ui/generator/button-generator.ts
/*!
...
let UIButtonGenerator = UIButtonGenerator_1 = class UIButtonGenerator extends ui/* UIElement */.u1 {
    constructor(jodit) {
        super(jodit);
        this.state = {
            text: '',
        ...
        this.preview = new UIPreviewButtonGenerator(this.j, this.state, this.updateState);
        this.form = new UIFormButtonGenerator(this.j, this.state, this.updateState);
        this.generateLibrary();
        const preview = this.getElm('preview');
        (0,helpers.assert)(preview != null, 'preview element does not exists');
        preview.appendChild(this.preview.container);
        const form = this.getElm('form');
        (0,helpers.assert)(form != null, 'form element does not exists');
    ...
    generateLibrary() {
        const group = new ui/* UIGroup */.qe(this.j);
        ...
        (0,helpers.assert)(library != null, 'library element does not exists');
...
UIButtonGenerator = UIButtonGenerator_1 = (0,tslib_es6/* __decorate */.gn)([
    decorators.component
], UIButtonGenerator);
...
;// CONCATENATED MODULE: ./src/plugins/button-generator/config.ts
/*!
 * Jodit Editor PRO (https://xdsoft.net/jodit/)
 * See LICENSE.md in the project root for license information.
 * Copyright (c) 2013-2022 Valeriy Chupurnov. All rights reserved. https://xdsoft.net/jodit/pro/
...
config/* Config.prototype.controls.buttonGenerator */.D.prototype.controls.buttonGenerator = {
...
config/* Config.prototype.popup.button */.D.prototype.popup.button = ['buttonGenerator'];
if ((0,checker/* isArray */.kJ)(config/* Config.prototype.popup.a */.D.prototype.popup.a)) {
    config/* Config.prototype.popup.a.push */.D.prototype.popup.a.push('buttonGenerator');
}

// EXTERNAL MODULE: ./src/core/ui/button/index.ts + 2 modules
var ui_button = __webpack_require__(17460);
;// CONCATENATED MODULE: ./src/plugins/button-generator/button-generator.ts
...
class buttonGenerator extends core_plugin/* Plugin */.Sy {
    constructor() {
        super(...arguments);
    ...
    toggleButtonGenerator(target) {
        ...
        if (target && !dom/* Dom.isTag */.i.isTag(target, ['button', 'a'])) {
            target = undefined;
        }
        const ui = this.__ui;
    ...
    onDblClick(e) {
        if (dom/* Dom.isTag */.i.isTag(e.target, 'button')) {
...
src.Jodit.plugins.add('button-generator', buttonGenerator);
...
/******/ var __webpack_exports__ = (__webpack_exec__(50061));
