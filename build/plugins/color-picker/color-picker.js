...
return (self["webpackChunkidist_jodit"] = self["webpackChunkidist_jodit"] || []).push([[652],{
...
var colorPicker = (function (_super) {
    ...
    colorPicker.prototype.afterInit = function (jodit) {
        jodit.e.on('afterGenerateColorPicker', this.onAfterGenerateColorPicker);
    };
    colorPicker.prototype.onAfterGenerateColorPicker = function (ignore, extra, callback, color) {
        modules_1.Dom.detach(extra);
        var ci = new color_input_1.ColorInput(this.j, {
            value: color || '#000',
            onChange: callback
        });
        extra.appendChild(ci.container);
    };
    colorPicker.prototype.beforeDestruct = function (jodit) {
...
index_1.Jodit.plugins.add('color-picker', colorPicker);
